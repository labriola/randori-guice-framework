...
public class TypeBinding extends AbstractBinding {
	...
	override public function provide(injector:Injector):Object {
		...
		if ( dependencyDefinition.isProxy() ) {
			dependencyDefinition = typeDefinitionFactory.definitionFromProxy( dependencyDefinition );
		}

		return injector.buildClass(dependencyDefinition);
	}

	public function TypeBinding(typeDefinition:TypeDefinition, dependencyDefinition:TypeDefinition, typeDefinitionFactory:TypeDefinitionFactory ) {
